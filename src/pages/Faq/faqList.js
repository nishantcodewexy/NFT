...
export default function EnhancedTable() {
    ...
    function updateFaqId(id) 
    {
        
       // alert(e.target.id);
        if(id!='') {
            console.log(id,'updatee')
             window.location="/faqUpdate/"+id;
        }   
    }
...
<div className="page_header">
                {/* <h2>User List</h2> */}
                <Button variant="contained" color="primary" onClick={addFaq} >Add Faq</Button>
            </div>
                </Toolbar>
                <TableContainer>
                    <Table
                            ...
                            {faq && faq.map((row, index) => {
                                ...
                                return (
                                    <TableRow>
                                        ...
                                        <Link onClick={() => updateFaqId(row._id)}><EditIcon  style={{ color: "#109ebf" }} /></Link>
                                        <Link onClick={() => deleteFaqId(row._id)}><DeleteIcon  style={{ color: "#109ebf" }} /></Link>
