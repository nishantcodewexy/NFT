...
// import action
import { getAddressProof, UpdateStatus } from './../../actions/docsVerify';

// import lib
import { addressProofName } from '../../lib/statusCode'
...
const AddressProof = (props) => {
    ...
    const fetchProof = async () => {
        try {
            setLoading(true)
            const { status, loading, error, result } = await getAddressProof();
            setLoading(loading)
            if (status == 'success') {
                ...
                <Card>
                    ...
                    <CardHeader color="primary">
                        <div className={classes.flexHeader}>
                            <h4 className={classes.cardTitleWhite}>Address Proof List</h4>
                        </div>
                    </CardHeader>
                    <CardBody>
