...
import { getBankDetails, UpdateStatus } from './../../actions/users';
...
const headCells = [
    { id: 'FirstName', numeric: false, disablePadding: false, label: 'Type' },
    { id: 'lastName', numeric: true, disablePadding: false, label: 'VotedId proof' },
    { id: 'email', numeric: true, disablePadding: false, label: 'Aathaar proof' },
    { id: 'phoneNo', numeric: true, disablePadding: false, label: 'AddressProof' },
