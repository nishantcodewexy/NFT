...
export default function EnhancedTable() {
  ...
  const getAll = async (search = {}) => {
    ...
    var test = await getquestionlist();
  ...
  async function showdetail(iiid) {
    window.location = "//questiondetail/" + iiid;
  }
                ...
                .map((use, index) => {
                  return (
                    <TableRow>
                      ...
                      <TableCell align="center">
                        {use.emailinfo && use.emailinfo.email
                          ? use.emailinfo.email
                          : ""}
                      </TableCell>
                      <TableCell align="center">
                        <p className="text_over_fl">
                          {ReactHtmlParser(use.question)}
                        </p>
                      </TableCell>
                      <TableCell align="center">
                        <Link onClick={() => showdetail(use._id)}>
                          <VisibilityIcon style={{ color: "#109ebf" }} />
                        </Link>
                        {use.emailinfo &&
                          use.emailinfo.email &&
                          use.emailinfo.email != null &&
                          use.emailinfo.email != "" && (
                            <Link onClick={() => editR(use.emailinfo.email)}>
                              <EditIcon style={{ color: "#109ebf" }} />
                            </Link>
                          )}
                        <Link onClick={() => handleDelete(use._id)}>
