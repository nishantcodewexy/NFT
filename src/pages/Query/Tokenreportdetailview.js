...
import { gettokenreportsingledetails, getuserdet } from "../../actions/users";
...
export default function EditCategory() {
  ...
  async function getdetails() {
    ...
    var data = await gettokenreportsingledetails(input);
    ...
    getuserdetail(data.result.data.report[indee].address);
  }

  async function getuserdetail(address) {
    var data = {
      address: address
    };
    var rest = await getuserdet(data);
    console.log(rest);
    setuserdetail(rest.result.data);
  }
  ...
  const back = async () => {
    window.location.href = "//tokenreport";
  };
                ...
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={12} md={4}>
                    <CustomInput
                      ...
                      id="email"
                      value={
                        userdetail && userdetail.email ? userdetail.email : ""
                      }
                      formControlProps={{
                        fullWidth: true
                      }}
                  ...
                  <GridItem xs={12} sm={12} md={4}>
                    <CustomInput
                      labelText="Report On"
                      id="report"
                      value={list && list.tokenOwner ? list.tokenOwner : ""}
                      formControlProps={{
                        fullWidth: true
                      }}
                      inputProps={{
