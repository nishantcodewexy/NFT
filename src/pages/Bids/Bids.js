...
import { getBidslist,getAllcategory , deletecategory } from './../../actions/users';
                    ...
                    >
                        ...
                        <TableBody>
                            {stableSort(userDetails, getComparator(order, orderBy)).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
                                ...
                                return (
                                    <TableRow>
                                        <TableCell align="center">{row.tokenBidAmt}</TableCell>
                                        <TableCell align="center">{row.tokenBidAddress}</TableCell>
                                        <TableCell align="center">{row.tokenCounts}</TableCell>
