...
import { getAllnoties, deletenoties } from "./../../actions/users";
...
export default function EnhancedTable() {
  ...
  const getAll = async (search = {}) => {
    ...
    var res = await getAllnoties(filterData);
  ...
  const handleDelete = async (iid) => {
    try {
      ...
      const res = await deletenoties(data);
      console.log(res, "================================");
      ...
      <Paper className={classes.paper}>
        ...
        >
          ...
          <div className={classes.flexHeader}>
            <Link to={"/notiesadd"} className={classes.btnPrimary}>
              Add Noties
            </Link>
          </div>
        </Toolbar>
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center">
                          {moment(row.timestamp).format("DD-MM-YYYY  h:mm a ")}
                        </TableCell>
                        <TableCell align="center">
