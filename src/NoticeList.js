  ...
  const handleAutoClose = () => {
    ...
    return(
        ...
        <div className="align-items-center mt-2" style={{fontWeight: "700", display:"flex"}}>
            ...
            <div style={{flex:"1"}}>
                <Button style={{backgroundColor:"#fff", color:"#5376FF", padding:"0 2px"}} onClick={handleClickOpenHistory} > 초기화 </Button>
            </div>
        </div>
    ...
    >
      ...
      <DialogTitle id="alert-dialog-title" className="d-flex justify-content-center mt-3"><strong>{"WORK HISTORY"}</strong></DialogTitle>

    <DialogContent>
        <div className="d-flex justify-content-center">
        <img src ={historyImage} style={{borderRadius:"8px 8px 45px 8px"}} />
        </div>
      ...
      <Table className={classes.table} aria-label="simple table">
        ...
        <DialogActions className="d-flex justify-content-center mb-5 mt-2">
          <Button fullwidth onClick={handleAutoClose} style={{backgroundColor:"#183B56", color: "#fff", margin: "0 4%"}}>
            돌아가기
          </Button>
        </DialogActions>
    </Dialog>
